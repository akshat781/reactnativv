    ...
    return (
        <div className="flex items-center  py-3">
            <div className="flex items-center space-x-2 ">
                <img onClick={()=>router.push('/')} className="h-7 md:h-10 ml-5 mr-3 cursor-pointer " src="https://www.freepnglogos.com/uploads/google-logo-png-hd-11.png" />
                </div>
...
<SearchIcon onClick={search}  className="h-5  cursor-pointer text-blue-500"/> 
            ...
            <div className="ml-auto mr-5">
                <img  className=" md:h-10 w-10 rounded-full hidden"src="https://s.yimg.com/fz/api/res/1.2/uOhm8o0J01vBXJnhB0wu0g--~C/YXBwaWQ9c3JjaGRkO2ZpPWZpbGw7aD0yMjA7cT04MDt3PTMzMA--/https://s.yimg.com/zb/imgv1/3ca0a65d-b3fb-31d5-b14d-5de7609bb580/t_500x300 "/>
            </div>
